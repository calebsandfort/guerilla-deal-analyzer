...
export const findProperty = async (term) => {
    ...
    //utilities.writeFile(FILE_PATH + "zillowData.json", $("script#hdpApolloPreloadedData", html).first().html())
    ...
    property.address = `${zillowData.address.streetAddress} ${zillowData.address.city}, ${zillowData.address.state} ${zillowData.address.zipcode}`;
